...
typedef enum {
    ...
    NETDEV2_EVENT_TX_COMPLETE_DATA_PENDING, /**< Rx ACK with frame pending bit */
	...
	NETDEV2_EVENT_RX_PENDING,       /**< receive a packet with pending bit */
	NETDEV2_EVENT_RX_DATAREQ,       /**< receive a data request command */
