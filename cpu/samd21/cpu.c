...
static void clk_init(void)
{
    /* 
       ...
       Note: OSCULP32K consumes 115nA and DFLL48M consumes 403uA
    */
    ...
    /* hskim: Setup OSCULP32K to feed Clock generator 1 with 32.768kHz*/ 
	...
	/* hskim: Setup Clock generator 1 to feed DFLL48M with 32.768kHz */
    GCLK->CLKCTRL.reg = (GCLK_CLKCTRL_GEN(1) |
						 GCLK_CLKCTRL_ID(GCLK_CLKCTRL_ID_GCLK_DFLL48MREF_Val) |
                         //GCLK_CLKCTRL_ID(GCLK_CLKCTRL_ID_GCLK_DPLL_Val) |
                         GCLK_CLKCTRL_CLKEN);
    while (GCLK->STATUS.reg & GCLK_STATUS_SYNCBUSY) {}

	/* hskim: Enable DFLL48M */
    ...
    /* hskim: Setup DFLL48M to feed Clock generator 0 (CPU core clock) */
    GCLK->GENDIV.reg =  (GCLK_GENDIV_DIV(0) | //CLOCK_PLL_DIV) |
                        GCLK_GENDIV_ID(0));
    GCLK->GENCTRL.reg = (GCLK_GENCTRL_GENEN |
    ...
    GCLK->GENDIV.reg =  (GCLK_GENDIV_DIV(0) | //CLOCK_DIV) |
                        GCLK_GENDIV_ID(0));
    GCLK->GENCTRL.reg = (GCLK_GENCTRL_GENEN |
                         GCLK_GENCTRL_SRC_OSCULP32K |
                         GCLK_GENCTRL_ID(0));
	...
	/* hskim: Turn off OSC8M which is the default main oscilator. 
	          Given that OSC8M was originally the source of Clock generator 0, 
